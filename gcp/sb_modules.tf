...
module hive {
    ...
    primary_ip_address      = var.create_rds ? module.cloud_sql.private_ip_address : "dummy"
    primary_db_port         = "5432"
    primary_db_user         = var.create_rds ? module.cloud_sql.primary_db_user : "dummy"
    primary_user_password   = var.create_rds ? module.cloud_sql.primary_db_password : "dummy"
    ...
    depends_on              = [postgresql_database.databases,module.gke]
}
...
module ranger {
    ...
    depends_on              = [postgresql_database.databases,module.hive]
}
